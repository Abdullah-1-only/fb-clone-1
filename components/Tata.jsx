...
const Tata = () => {
  return (<div className='h-screen bg-[#dedee4]'>
    <div className="flex flex-row items-center">
      <div className=" flex flex-col mt-20">
        <svg xmlns="http://www.w3.org/2000/svg" className='ml-8' width="500" height="110" fill="none" viewBox="0 0 1090 360">
        ...
        <h2 className="font-sans text-3xl ml-36 w-[73%] whitespace-pre-line mt-[-1.5%] ">Facebook helps you connect and share with the people in your life.</h2>
      </div>

      <form className="bg-white flex flex-col w-[540px] items-center shadow-lg rounded-lg mr-[12%] mt-[10%] h-[43%] ">

        <input type="text" placeholder='Email address or phone number' className='mt-3 mb-3 pl-3 w-[22rem] border-[2px] rounded-md border-[#0000001b] h-[3rem]' />
        <input type="text" placeholder='Password' className='border-[2px] border-[#0000001b] h-[3rem] w-[22rem] pl-3 rounded-md ' />

        <button className='hover:bg-[#3d63e1f9] bg-blue-600 text-white rounded-md text-xl font-bold pr-[145px] pl-[145px] pt-[9px] pb-[9px] mt-3 '> Log in</button>

        <a href="http://facebook.com" className='hover:underline text-blue-500 font-sans pt-4 font-semibold '>Forgotten password?</a>

        <div className="flex justify-center border-t-[1px] w-[350px] border-[#0000002b] mt-5 ">
          <button className='hover:bg-[#41a346] bg-[#21b02b] pr-[30px] pl-[30px] pt-3 pb-3  mt-5 mb-6 rounded-md text-white font-sans font-bold  '>Create new account</button>
        </div>
      </form>
    </div>
    <div className=" flex justify-end mr-[11.5rem] mt-6    font-sans">
          <p className='font-semibold font-sans'>Create a Page  </p> <br />
          <p className='font-sans'>, for a celebrity, brand or business.</p>
        </div>
